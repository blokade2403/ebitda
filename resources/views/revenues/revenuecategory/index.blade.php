                                ...
                                <tbody>
                                    ...
                                    @foreach ($categories as $cat)
                                        <tr>
                                            ...
                                            <td>
                                                <span class="text-primary">{{ $cat->id }}</span>
                                            </td>
                                            ...
                                            <td class="text-center">
                                                ...
                                                <form action="{{ route('revenue_categories.destroy', $cat->id) }}"
                                        ...
                                        @include('revenues.revenuecategory.modal_edit_data')
                                    @endforeach
                                </tbody>
                            </table>
                        </div>
                    </div>
                    @include('revenues.revenuecategory.modal_add_data')
