    ...
    <div class="row">
        <div class="col-lg-12">
            <div class="card" id="orderList">
                ...
                @include('revenues.medicalservices.modal_upload_data')
                                ...
                                <tbody>
                                    ...
                                    @foreach ($services as $cat)
                                        <tr>
                                            ...
                                            <td>
                                                <span class="text-primary">{{ $cat->unit->nama_unit }}</span>
                                            </td>
                                            <td>
                                                <strong>{{ $cat->category->nama }}</strong>
                                            </td>
                                            <td>
                                                <strong>{{ $cat->nama_layanan }}</strong>
                                            </td>
                                            <td>
                                                <strong>{{ $cat->tarif }}</strong>
                                            </td>
                                            <td>
                                                @if ($cat->is_active)
                                            ...
                                            <td class="text-center">
                                                ...
                                                <form action="{{ route('medical_services.destroy', $cat->id) }}"
                                        ...
                                        @include('revenues.medicalservices.modal_edit_data')
                                    @endforeach
                                </tbody>
                            </table>
                        </div>
                    </div>
                    @include('revenues.medicalservices.modal_add_data')
