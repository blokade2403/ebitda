             ...
             <div class="d-flex">
                 ...
                 <div class="navbar-brand-box horizontal-logo">
                     <a href="{{ route('dashboard') }}" class="logo logo-dark">
                         ...
                         <span class="logo-lg">
                             <img src="{{ asset('assets/images/ebitda.png') }}" alt="" height="57">
                         </span>
                     </a>
                     ...
                     <button type="button" class="btn" id="page-header-user-dropdown" data-bs-toggle="dropdown"
                         ...
                         <span class="d-flex align-items-center">
                             ...
                             <span class="text-start ms-xl-2">
                                 <span
                                     class="d-none d-xl-inline-block ms-1 fw-medium user-name-text">{{ session('nama') }}</span>
                                 <span
                                     class="d-none d-xl-block ms-1 fs-12 text-muted user-name-sub-text">{{ session('nama_jabatan') }}</span>
                             </span>
                         </span>
                     </button>
