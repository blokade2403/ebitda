        ...
        <div class="col-lg-12">
            <div class="card" id="orderList">
                ...
                <div class="container">
                    ...
                    <h4 class="mb-4">Input Patient Target</h4>
                    ...
                    <form method="POST" action="{{ route('targets.store') }}">
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-md-3">
                                ...
                                <input type="number" name="target_pasien" class="form-control" required>
                            </div>
                    ...
                    @include('targets.modal_add_data')
                ...
                <div class="card-body pt-0">
                    <div>
                        ...
                        @endif
                        @include('targets.filter', ['routePrefix' => $routePrefix])
                                ...
                                <tbody>
                                    @foreach ($targets as $visit)
                                        <tr>
                                            ...
                                            <td>{{ $visit->target_pasien }}</td>
                                            <td>
                                                Rp
                                                {{ number_format($visit->target_pasien * $visit->service->tarif, 0, ',', '.') }}
                                            </td>
                                            <td>
