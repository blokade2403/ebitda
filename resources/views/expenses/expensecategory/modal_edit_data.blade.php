                 ...
                 <div class="modal-body">
                     ...
                     <div class="mb-3">
                         ...
                         <select class="form-control" data-trigger name="kelompok">
                             <option value="DOC Variable" {{ $cat->kelompok == 'DOC Variable' ? 'selected' : '' }}>DOC
                                 Variable</option>
                             <option value="DOC Fixed" {{ $cat->kelompok == 'DOC Fixed' ? 'selected' : '' }}>DOC Fixed
                             </option>
                             <option value="IOC" {{ $cat->kelompok == 'IOC' ? 'selected' : '' }}>IOC</option>
                         </select>
                     </div>
