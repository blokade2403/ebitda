                                    ...
                                    <div class="d-flex mb-3">
                                        ...
                                        <div class="flex-shrink-0">
                                            <a href="javascript:void(0);"
                                                class="badge badge-soft-warning badge-border">BTC</a>
                                            <a href="javascript:void(0);"
                                                class="badge badge-soft-info badge-border">ETH</a>
                                            <a href="javascript:void(0);"
                                                class="badge badge-soft-primary badge-border">USD</a>
                                            <a href="javascript:void(0);"
                                                class="badge badge-soft-danger badge-border">EUR</a>
                                        </div>
                                    </div>
                                    <h3 class="mb-2">$<span class="counter-value"
                                            data-target="74858">0</span><small class="text-muted fs-13">.68k</small>
                                    </h3>
                        ...
                        <div class="col-xxl-3 col-md-6">
                            <div class="card card-animate">
                                <div class="card-body">
                                    ...
                                    <h3 class="mb-2">$<span class="counter-value"
                                            data-target="74361">0</span><small class="text-muted fs-13">.34k</small>
                                    </h3>
                        ...
                        <div class="col-xxl-3 col-md-6">
                            <div class="card card-animate">
                                <div class="card-body">
                                    ...
                                    <h3 class="mb-2">$<span class="counter-value"
                                            data-target="97685">0</span><small class="text-muted fs-13">.22k</small>
                                    </h3>
                                        ...
                                        <div class="card card-animate">
                                            <div class="card-body bg-soft-warning">
                                                <div class="d-flex mb-3">
                                                    ...
                                                    <div class="flex-shrink-0">
                                                        <a href="javascript:void(0);" class="fw-medium">Bitcoin
                                                            (BTC)</a>
                                                    </div>
                                                </div>
                                                <h3 class="mb-2">$245<small class="text-muted fs-13">.65k</small>
                                                </h3>
                                        ...
                                        <div class="card card-animate">
                                            <div class="card-body bg-soft-warning">
                                                <div class="d-flex mb-3">
                                                    ...
                                                    <div class="flex-shrink-0">
                                                        <a href="javascript:void(0);" class="fw-medium">Ethereum
                                                            (ETH)</a>
                                                    </div>
                                                </div>
                                                <h3 class="mb-2">$24<small class="text-muted fs-13">.74k</small>
                                                </h3>
                                                <h6 class="text-muted mb-0">Send - Receive (Previous Month)</h6>
                                            </div>
                                        </div><!--end card-->
                                        ...
                                        <div class="card card-animate">
                                            <div class="card-body bg-soft-warning">
                                                <div class="d-flex mb-3">
                                                    ...
                                                    <div class="flex-shrink-0">
                                                        <a href="javascript:void(0);" class="fw-medium">Monero
                                                            (XMR)</a>
                                                    </div>
                                                </div>
                                                <h3 class="mb-2">$124<small class="text-muted fs-13">.36k</small>
                                                </h3>
                                                <h6 class="text-muted mb-0">Send - Receive (Previous Month)</h6>
                                            </div>
                                        </div><!--end card-->
                            ...
                            <div class="table-responsive table-card">
                                <table class="table align-middle table-nowrap" id="customerTable">
                                    <thead class="table-light text-muted">
                                        <tr>
                                            ...
                                            <th class="sort" data-sort="currency_name" scope="col">Currency
                                            </th>
                                    ...
                                    <tbody class="list form-check-all">
                                        <tr>
                                            ...
                                            <td class="date">24 Dec, 2021 <small
                                            ...
                                            <td class="status">
                                                <span class="badge badge-soft-warning fs-11"><i
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <div class="avatar-xs">
                                                    <div
                                                        class="avatar-title bg-soft-success text-success rounded-circle fs-16">
                                                        <i class="ri-arrow-left-down-fill"></i>
                                                    </div>
                                                </div>
                                            </td>
                                            <td class="date">16 Dec, 2021 <small
                                                    class="text-muted">10:32PM</small></td>
                                            <td class="currency_name">
                                                <div class="d-flex align-items-center">
                                        ...
                                        <tr>
                                            ...
                                            <td class="date">04 Jan, 2022 <small
                                                    class="text-muted">02:24AM</small></td>
                                            <td class="currency_name">
                                                <div class="d-flex align-items-center">
                                                    <img src="{{ asset('assets/images/svg/crypto-icons/eur.svg') }}"
                                                        alt="" class="avatar-xxs me-2">
                                                    EUR
                                                </div>
                                            </td>
                                        ...
                                        <tr>
                                            ...
                                            <td class="date">28 Oct, 2021 <small
                                                    class="text-muted">11:42AM</small></td>
                                            <td class="currency_name">
                                                <div class="d-flex align-items-center">
                                                    <img src="{{ asset('assets/images/svg/crypto-icons/gbp.svg') }}"
                                                        alt="" class="avatar-xxs me-2">
                                                    GBP
                                                </div>
                                            </td>
                                        ...
                                        <tr>
                                            ...
                                            <td class="date">14 Nov, 2021 <small
                                                    class="text-muted">12:38PM</small></td>
                                            <td class="currency_name">
                                                <div class="d-flex align-items-center">
                                                    <img src="{{ asset('assets/images/svg/crypto-icons/jpy.svg') }}"
                                                        alt="" class="avatar-xxs me-2">
                                                    JPY
                                                </div>
                                            </td>
                                        ...
                                        <tr>
                                            ...
                                            <td class="currency_name">
                                                <div class="d-flex align-items-center">
                                                    <img src="{{ asset('assets/images/svg/crypto-icons/xrp.svg') }}"
                                                        alt="" class="avatar-xxs me-2">
                                                    XRP
                                                </div>
                                            </td>
                                        ...
                                        <tr>
                                            ...
                                            <td class="date">17 Oct, 2021 <small
                                                    class="text-muted">07:08PM</small></td>
                                            <td class="currency_name">
                                                <div class="d-flex align-items-center">
                                        ...
                                        <tr>
                                            ...
                                            <td class="date">27 Dec, 2021 <small
                                                    class="text-muted">01:24PM</small></td>
                                            <td class="currency_name">
                                                <div class="d-flex align-items-center">
                                                    <img src="{{ asset('assets/images/svg/crypto-icons/xmr.svg') }}"
                                                        alt="" class="avatar-xxs me-2">
                                                    XMR
                                                </div>
                                            </td>
                                        ...
                                        <tr>
                                            ...
                                            <td class="date">23 Dec, 2021 <small
                                                    class="text-muted">01:47AM</small></td>
                                            <td class="currency_name">
                                                <div class="d-flex align-items-center">
                                                    <img src="{{ asset('assets/images/svg/crypto-icons/xpm.svg') }}"
                                                        alt="" class="avatar-xxs me-2">
                                                    XPM
                                                </div>
                                            </td>
                                        ...
                                        <tr>
                                            ...
                                            <td class="currency_name">
                                                <div class="d-flex align-items-center">
                                                    <img src="{{ asset('assets/images/svg/crypto-icons/ppt.svg') }}"
                                                        alt="" class="avatar-xxs me-2">
                                                    PPT
                                                </div>
                                            </td>
                                ...
                                <div class="noresult" style="display: none">
                                    <div class="text-center">
                                        ...
                                        <p class="text-muted mb-0">We've searched more than 150+ transactions We did
                                            not find any
