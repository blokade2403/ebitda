                                ...
                                <tbody>
                                    ...
                                    @foreach ($units as $unit)
                                        <tr>
                                            ...
                                            <td>{{ $no++ }}</td>
                                            <td><span class="text-primary">{{ $unit->nama_unit }}</span></td>
                                            <td><strong>{{ $unit->created_at->format('d M Y H:i') }}</strong></td>
                                        ...
                                        @include('master_backend.setting_users.unit.modal_edit_data')
                                    @endforeach
                                </tbody>
                            </table>
                        </div>
                    </div>
                    @include('master_backend.setting_users.unit.modal_add_data')
